...
/***
 * 
 * USAGE:   This script is developed to process vehicle advert Uploads 
 *          
 *          TOOLS    : Core PHP, No Libraries!
 *          DEVELOPER: OMAE SOFTWARE[Cornelius Kasokola]
...
$o["wforce"] = null;
if($DescriptionSanitize->description($_POST["wforce"])){
    $o["wforce"] = $DescriptionSanitize->description($_POST["wforce"]);
...
$o["input"] = null;
if($DescriptionSanitize->description($_POST["input"])){
    $o["input"] = $DescriptionSanitize->description($_POST["input"]);
...
$o["pyield"] = null;
if($DescriptionSanitize->description($_POST["pyield"])){
    $o["pyield"] = $DescriptionSanitize->description($_POST["pyield"]);
...
$o["loss"] = null;
if($DescriptionSanitize->description($_POST["loss"])){
    $o["loss"] = $DescriptionSanitize->description($_POST["loss"]);
...
$o["profit"] = null;
if($DescriptionSanitize->description($_POST["profit"])){
    $o["profit"] = $DescriptionSanitize->description($_POST["profit"]);
...
$o["sprocedure"] = null;
if($DescriptionSanitize->description($_POST["sprocedure"])){
    $o["sprocedure"] =$DescriptionSanitize->description($_POST["sprocedure"]);
...
$o["mprocedure"] = null;
if($DescriptionSanitize->description($_POST["mprocedure"])){
    $o["mprocedure"] = $DescriptionSanitize->description($_POST["mprocedure"]);
...
$o["yprocedure"] = null;
if($DescriptionSanitize->description($_POST["yprocedure"])){
    $o["yprocedure"] = $DescriptionSanitize->description($_POST["yprocedure"]);
...
$o["rprocedure"] = null;
if($DescriptionSanitize->description($_POST["rprocedure"])){
    $o["rprocedure"] = $DescriptionSanitize->description($_POST["rprocedure"]);
