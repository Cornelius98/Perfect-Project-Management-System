...
/**************************************
 * 
 * USAGE: This file adds new files for 
 *        a project
 *       
...
<html>
<head>
    <?php $AdminiUXTemplate->headers('New Files Project');?>
    ...
    <script>
        ...
        $("#migrateAdd").click(function(evt){
            ...
            let formData = new FormData(),
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../middleware/admini/handleAdvert/mw_project_push_files',
                    processData: false,
                    contentType: false,
                    async: true,
                    data:formData,
                    ...
                    success:function(s,status,settings){
                        ...
                        if(q["status"]==200){
                            $(".error-display").html('<div class="e-success">Files Successfully Published</div>');
