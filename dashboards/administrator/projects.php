...
if(is_array($totalProducts[0]) && ($totalProducts[0]["total_projects"]>=1)){
    ...
    if($page <1) $page = 1;
    $productsContainer = $ProductPull->get_projects_oo($offset,$products_per_page,$adr_key);
}
// $Utility->pretty_print($productsContainer);
// exit();
?>
<!DOCTYPE html>
<html>
                ...
                <div id="post-wrapper-fader">
                    <div class="row">
                        ...
                        <section class="col-sm-12 col-md-9 col-lg-9 col-xl-9 section">
                            ...
                            <h5>Projects Created(<?php echo $total_products;?>)</h5>
                            <hr>
                            <br>
